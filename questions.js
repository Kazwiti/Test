...
const funMaleTruths = [
  ...
  "Placeholder fun male truth 2",
  "Placeholder fun male truth 3",
  "Placeholder fun male truth 4",
  "Placeholder fun male truth 5",
  "Placeholder fun male truth 6",
  "Placeholder fun male truth 7",
  "Placeholder fun male truth 8",
  "Placeholder fun male truth 9",
  "Placeholder fun male truth 10",
  "Placeholder fun male truth 11",
  "Placeholder fun male truth 12",
  "Placeholder fun male truth 13",
  "Placeholder fun male truth 14",
  "Placeholder fun male truth 15"
];
const funFemaleTruths = [
  "Placeholder fun female truth 1",
  "Placeholder fun female truth 2",
  "Placeholder fun female truth 3",
  "Placeholder fun female truth 4",
  "Placeholder fun female truth 5",
  "Placeholder fun female truth 6",
  "Placeholder fun female truth 7",
  "Placeholder fun female truth 8",
  "Placeholder fun female truth 9",
  "Placeholder fun female truth 10",
  "Placeholder fun female truth 11",
  "Placeholder fun female truth 12",
  "Placeholder fun female truth 13",
  "Placeholder fun female truth 14",
  "Placeholder fun female truth 15"
];
const funMaleDares = [
  "Placeholder fun male dare 1",
  "Placeholder fun male dare 2",
  "Placeholder fun male dare 3",
  "Placeholder fun male dare 4",
  "Placeholder fun male dare 5",
  "Placeholder fun male dare 6",
  "Placeholder fun male dare 7",
  "Placeholder fun male dare 8",
  "Placeholder fun male dare 9",
  "Placeholder fun male dare 10",
  "Placeholder fun male dare 11",
  "Placeholder fun male dare 12",
  "Placeholder fun male dare 13",
  "Placeholder fun male dare 14",
  "Placeholder fun male dare 15"
];
const funFemaleDares = [
  "Placeholder fun female dare 1",
  "Placeholder fun female dare 2",
  "Placeholder fun female dare 3",
  "Placeholder fun female dare 4",
  "Placeholder fun female dare 5",
  "Placeholder fun female dare 6",
  "Placeholder fun female dare 7",
  "Placeholder fun female dare 8",
  "Placeholder fun female dare 9",
  "Placeholder fun female dare 10",
  "Placeholder fun female dare 11",
  "Placeholder fun female dare 12",
  "Placeholder fun female dare 13",
  "Placeholder fun female dare 14",
  "Placeholder fun female dare 15"
];
...
const questionSets = {
  spicy: {
    male: { truths: maleTruths, dares: maleDares },
    female: { truths: femaleTruths, dares: femaleDares }
  },
  fun: {
    male: { truths: funMaleTruths, dares: funMaleDares },
    female: { truths: funFemaleTruths, dares: funFemaleDares }
  }
};